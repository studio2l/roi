...
`
	...
	mux.HandleFunc("/assets", handle(assetsHandler))
	mux.HandleFunc("/update-multi-assets", handle(updateMultiAssetsHandler))
	mux.HandleFunc("/add-asset", handle(addAssetHandler))
	mux.HandleFunc("/update-asset", handle(updateAssetHandler))
